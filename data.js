...
const ORDERS = [
  ...
  { id: 3508, status: 'qa_review', customerId: 'c-ls', workType: 'bachelorarbeit', title: 'Nachhaltigkeit in der Modeindustrie', field: 'Marketing', pages: 40, finalDeadline: '2026-05-20T18:00:00', interimDeadline: '2026-05-08T18:00:00', grossEur: 2360, netHonorarium: 793.46, rate: 0.36, gwId: 'gw-mp', leadSource: 'ig', acceptedAt: '2026-04-01', paidEur: 1180, outstandingEur: 1180, installments: [{n:1,amt:1180,status:'paid',date:'2026-04-01',method:'stripe_card'},{n:2,amt:1180,status:'scheduled',date:'2026-05-15',method:'stripe_card'}], revisionRounds: 2, gwPaymentStatus: 'work_in_progress', lastDisputeAt: '2026-05-06T18:45:00', disputes: [{ id: 'd-seed-3508', openedBy: 'customer', openedById: 'c-ls', openedAt: '2026-05-06T18:45:00', reasonCategory: 'quality', reason: 'Kapitel 4 entspricht nach zwei Überarbeitungen weiterhin nicht der besprochenen Struktur und Tiefe — ich benötige eine grundlegende Korrektur.', status: 'open', outcome: null, outcomeNote: '', resolvedAt: null, resolvedBy: null, adminNotes: [], affectedSubmissionId: null, alsoBlockedGw: false, extensionRef: null }] },
...
const STATUS_PILLS = {
  ...
  // Completed (green)
  delivered:                { color: 'yellow', label: 'Customer Review' },
  ...
  extension_customer_approval_pending: { color: 'yellow', label: 'Extension · Customer Approval' },
