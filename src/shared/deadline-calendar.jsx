// Shared DeadlineCalendar — renders a monthly calendar of order deadlines.
// Accepts any filtered array of orders; data fetching stays in the caller.
...
// orders      — filtered array of order objects to show deadlines for
