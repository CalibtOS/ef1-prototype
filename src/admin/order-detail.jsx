  ...
  const approveClaim = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        text: 'Briefing sent · customer notified their GW is assigned',
      });
    }, 1700);
      ...
      {isClaim && (
        <div className="banner info mb-3">
          ...
          <div style={{ flex: 1 }}>
            ...
            On approve: the GW briefing and the customer&apos;s assignment notice (a link into the order chat) send simultaneously. The introduction itself is posted by the GW in the order chat.
          </div>
          ...
          <div className="modal" style={{ maxWidth: 620 }}>
            ...
            <div className="modal-footer">
              <span className="text-faint fs-11">
                ...
                {approving.phase === 'cust' && 'Sending customer assignment notice…'}
...
function AssignmentTab({ order, navigate, toast }) {
  ...
  const onAssign = (g) => {
    ...
    if (toast) toast({
      ...
      text: `${g.name} assigned · briefing + customer assignment notice queued`,
    });
  };
  return (
